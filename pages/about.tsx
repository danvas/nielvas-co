...
function About() {
  return (
    <div className="container p-4">
      <div className="fs-3 fw-lighter pb-4">
      ...
      <div className="fw-light ">
        <p>
          I'm a software developer specializing in 3D workflows and digital content creation tools.
        </p>
        <p>
        ...
        <p>
          My deep appreciation for music compelled me to create <em>Lyddy</em> — a sound-sharing social networking web app aimed at uniting people through sound, allowing them to explore genres by means of hashtags. Have a listen at <a className="text-decoration-none" target="_blank" href="https://lyddy.stream/nielvas">my stream</a>.
        </p>
        <p>
        ...
        <p>
          Want to get in touch? I'm on <a className="text-decoration-none" href="https://www.linkedin.com/in/danvas" target="_blank">LinkedIn</a> and <a className="text-decoration-none" href="https://github.com/danvas" target="_blank">GitHub</a>. Feel free to reach out. Thanks for visiting!
        </p>
      </div>
